...
@Service
public class JsonToYamlParseServiceImpl implements ParserService {
    ...
    public Response parse(Request request) {
        try {
            ...
            return new Response(true, "success", yamlMapper.writerWithDefaultPrettyPrinter().writeValueAsString(jsonNode), HttpStatus.OK.toString());
        } catch (Exception e) {
